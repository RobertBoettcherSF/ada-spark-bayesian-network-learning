...
package body Bayesian_Network_Learning is
   ...
   begin
      Ordering := (1 .. Integer(Node_Id'Last) => Node_Id'First); -- Initialize with default values
      for I in Integer range 1 .. Integer(Node_Id'Last) loop
   ...
   begin
      ...
      for I in Node_Id loop
         for J in Integer range 1 .. Integer(Node_Id'Last) loop
      ...
      for I in 1 .. Ordering'Length loop
         declare
            ...
            Temp_Parents : Parent_Set(1 .. Integer(Node_Id'Last)) := (others => Node_Id'First);
